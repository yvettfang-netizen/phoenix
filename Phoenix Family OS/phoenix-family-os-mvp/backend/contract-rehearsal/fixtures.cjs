...
const TIMELINE_VISIBILITIES = Object.freeze(['FAMILY', 'SUBJECT', 'ADVISOR_SHARED', 'INTERNAL_RESTRICTED'])
const ADVISOR_CUSTOMER_COPY = Object.freeze(['顾问跟进', '预约顾问解读', '顾问服务'])
...
module.exports = {
  FAMILIES, USERS, STUDENTS, GUARDIAN, NOW, EXPIRES, DOMAINS, PURPOSES, SUBJECTS,
  TIMELINE_VISIBILITIES, ADVISOR_CUSTOMER_COPY, consentRef, fixture, coreFixture
}

  ...
  return (
    <main>
      <section className="hero" id="top">
        ...
        <Link className="world-guide-entry" href="/world">
          <span>进入凤启世界</span>
          <small>EXPLORE THE NOVA WORLD</small>
          <ArrowUpRight aria-hidden="true" />
        </Link>
        <nav className="realm-entry" aria-label="三重世界入口">
          ...
          <button className="realm-tab realm-tab-three" type="button" aria-label="第三重：鸿蒙世界，由凤凰星图进入" aria-disabled="true" title="由凤凰星图进入"><small>第三重</small><span>鸿蒙世界</span></button>
        </nav>
      </section>
    </main>
  );

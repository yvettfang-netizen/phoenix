...
const beasts = [
  { id: "phoenix", name: "凤凰", domain: "中枢", status: "统合中", color: "#c8a24a", href: "/founder/phoenix" },
  { id: "zhuque", name: "朱雀", domain: "视觉", status: "1 项待审", color: "#bd7b72", href: "/founder/beasts/zhuque" },
  { id: "xuanwu", name: "玄武", domain: "工程", status: "P0 执行", color: "#6e8992", href: "/founder/beasts/xuanwu" },
  { id: "baize", name: "白泽", domain: "审核", status: "2 项核验", color: "#9c9181", href: "/founder/beasts/baize" },
  { id: "qingluan", name: "青鸾", domain: "传播", status: "今日排期", color: "#7d9eaa", href: "/founder/beasts/qingluan" },
  { id: "aoyu", name: "鳌鱼", domain: "学习", status: "Pilot Live", color: "#6e9a91", href: "/founder/beasts/aoyu" },
  { id: "qilin", name: "麒麟", domain: "教育", status: "3 个成长信号", color: "#b99c68", href: "/founder/beasts/qilin" },
  { id: "pixiu", name: "貔貅", domain: "财富", status: "等待判断", color: "#a78458", href: "/founder/beasts/pixiu" },
  { id: "qinglong", name: "青龙", domain: "组织", status: "配置中", color: "#62a398", href: "/founder/beasts/qinglong" },
];
        ...
        <section className="console-panel console-beasts" id="beasts">
          ...
          <div>
            {beasts.map((beast) => (
              <Link
                href={beast.href}
                className="console-beast-link"
                key={beast.id}
                style={{ "--beast-color": beast.color } as CSSProperties}
                aria-label={`进入${beast.name} AI Agent 工作台`}
              >
                <i /><small>{beast.domain}</small><strong>{beast.name}</strong><span>{beast.status}</span>
              </Link>
            ))}
          </div>
        </section>

...
const {initialDocuments, daysUntil, renewDemoDocument, upsertDemoApplication, subjectRecords, allowedGoal} = await import(`data:text/javascript;base64,${Buffer.from(code).toString("base64")}`);

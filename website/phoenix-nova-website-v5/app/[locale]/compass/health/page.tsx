...
export default async function HealthPage({ params }: Props) {
  ...
  return <div lang={zh ? "zh-Hans" : "en"}>
    <header className="site-header">
      <div className="site-header__inner shell" style={{ display: "flex", flexWrap: "wrap", height: "auto", minHeight: 84, gap: 12, paddingTop: 16, paddingBottom: 16 }}>
        <BrandMark compact href={`/${locale}`} label={zh ? "Phoenix Nova 首页" : "Phoenix Nova home"} />
        <nav className="header-actions" aria-label={zh ? "健康罗盘导航" : "Health Compass navigation"}>
    ...
    <footer className="site-footer">
      <div className="shell site-footer__bottom" style={{ flexWrap: "wrap", gap: 16 }}>
